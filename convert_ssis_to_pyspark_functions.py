...
if __name__ == "__main__":
    ...
    main(
        ...
        prompt_text="convert SSIS task to Databricks Python functions with source and target table mapped to Unity catalog",
        ...
        3. Convert the SSIS executable to Databricks functions in Python 
        """,
